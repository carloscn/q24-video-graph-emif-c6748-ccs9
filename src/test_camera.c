...
#define             PIC0_ADDR            ( unsigned short * ) 0xc1000000
#define             PIC1_ADDR            ( unsigned short * ) 0xc2000000

unsigned short *origin  =  PIC0_ADDR;
unsigned short *gray    =  PIC1_ADDR;
...
// \return  UINT32
//-----------------------------------------------------------------------------
extern void pic_deal_gray( unsigned short *origin, unsigned short *gray );
extern void    get_camera_out( unsigned short *photo_datas );
...
UINT32 TEST_imageSensor(void)
{
   ...
   //-------------------------------------
   DebugPrintf("Initialize the Re quired BSL Modules\r\n");
   DebugPrintf("-----------------------------------\r\n\r\n");
   ...
   //get_camera_out( origin );
   //pic_deal_gray( origin,gray );
   return (rtn);
}
